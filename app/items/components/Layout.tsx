                  ...
                  <div className="flex justify-between items-center gap-3 ps-4">
                     <div className="relative h-[40px] w-[500px] rounded-md overflow-hidden px-[1px] shadow-sm focus:rounded-sm border-zinc-300 border outline-gray-300">
                        <input
                           ...
                           type="text"
                        />
                        <p className="absolute left-2 top-[50%] translate-y-[-50%]">{search}</p>
                     </div>
                  ...
                  <tr className="font-semibold text-[#333]">
                     ...
                     <td>
                        <span className="flex justify-evenly items-center gap-2 ">
                           {" "}
                           <button className="rounded-md text-lg fill-blue-500 bg-blue-200 w-8 h-8  transition-all hover:opacity-80 ps-2">
                              {pencil}
                           </button>
                           <button className="rounded-md text-lg fill-red-500 bg-red-200 w-8 h-8  transition-all hover:opacity-80 ">
                              {Delete}
                           </button>
                        </span>
                     </td>
